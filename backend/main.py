...
app = FastAPI(
    title="The_E_Project_Is_A_Web_Application_That_Provides_A_Platform_For_Users_To_Interact_With_Each_Other._The_Backend_Api_Will_Be_Built_Using_Fastapi_And_Sqlalchemy,_And_Will_Provide_Restful_Endpoints_For_The_React_Frontend_To_Consume. API",
...
@app.get("/health")
def health():
    return {"status": "healthy", "service": "the_e_project_is_a_web_application_that_provides_a_platform_for_users_to_interact_with_each_other._the_backend_api_will_be_built_using_fastapi_and_sqlalchemy,_and_will_provide_restful_endpoints_for_the_react_frontend_to_consume."}
